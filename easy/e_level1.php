...
$words = ["CUBE", "CONE", "STAR", "RING", "OVAL"];
$bodyParts = ["empty", "head", "neck", "body", "arm", "arms", "leg", "full"];

function getCurrentPicture($part) {
    return "<img src='../img/hangman_$part.png' width='100' height='150'>";
}
    ...
    if (isLetterCorrect($currentPressedKey) && !isBodyComplete() && !gameComplete()) {
        ...
        if (!isBodyComplete()) {
            ...
            if (isBodyComplete()) {
                markGameAsComplete();
                restartGame();
                header('Location: ../easy/lose1.html');
                exit();
            }
        } else {
            markGameAsComplete();
...
<html lang="en">
<head>
    <title>Hangman Game - Level 1</title>
    ...
    <div class="container">
        <div class="content-wrapper">
            <div class="hangman_img">
                <?php echo getCurrentPicture(getCurrentPart()); ?>
            </div>
            <div class="game-info">
                <div class="word">
                    <?php
